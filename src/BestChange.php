...
class BestChange
{
    private const string PREFIX_TMPFILE = 'nbc';
    private const string BESTCHANGE_FILE = 'http://api.bestchange.ru/info.zip';
    private const string FILE_CURRENCIES = 'bm_cy.dat';
    private const string FILE_CURRENCIES_CODES = 'bm_cycodes.dat';
    private const string FILE_EXCHANGERS = 'bm_exch.dat';
    private const string FILE_RATES = 'bm_rates.dat';
